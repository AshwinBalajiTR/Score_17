...
public class g6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(g6.this, "Created by Ashwin Balaji T R", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                double pra=3,prb=3,prc=3,prd=4,pre=3,prf=3,prg=2,prh=2,pri=1;
                ...
                if(a.getCheckedRadioButtonId() != -1 && b.getCheckedRadioButtonId() != -1 && c.getCheckedRadioButtonId() != -1
                    ...
                    Toast.makeText(g6.this, "Check all fields!", Toast.LENGTH_SHORT).show();
                }
