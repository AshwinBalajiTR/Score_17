...
public class g7 extends AppCompatActivity {
    RadioGroup a,b,c,d,e,f,g,h;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(g7.this, "Created by Ashwin Balaji T R", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double pra=4,prb=4,prc=3,prd=3,pre=3,prf=4,prg=2,prh=2;
                ...
                if(a.getCheckedRadioButtonId() != -1 && b.getCheckedRadioButtonId() != -1 && c.getCheckedRadioButtonId() != -1
                        ...
                        &&g.getCheckedRadioButtonId() != -1 && h.getCheckedRadioButtonId() != -1){
                    ...
                    double z = pra+prb+prc+prd+pre+prf+prg+prh;
                    double res = z/25;
                    ...
                    Toast.makeText(g7.this, "Check all fields!", Toast.LENGTH_SHORT).show();
