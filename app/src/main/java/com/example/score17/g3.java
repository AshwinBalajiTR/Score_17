...
public class g3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(g3.this, "Created by Ashwin Balaji T R", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                double pra=4,prb=4,prc=3,prd=3,pre=3,prf=2,prg=2,prh=2,pri=1;
                ...
                if(a.getCheckedRadioButtonId() != -1 && b.getCheckedRadioButtonId() != -1 && c.getCheckedRadioButtonId() != -1
                    ...
                    Toast.makeText(g3.this, "Check all fields!", Toast.LENGTH_SHORT).show();
                }
