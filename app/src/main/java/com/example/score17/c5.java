    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(c5.this, "Created by Ashwin Balaji T R", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double value=0,vv=0,vc=0,vd=0,ve=0;
                String cc="90000000";

                if(ta.isEmpty() && tb.isEmpty() && tc.isEmpty() && td.isEmpty() && te.isEmpty()){
                    Toast.makeText(c5.this, "Enter all fields!", Toast.LENGTH_LONG).show();
                }

                else if(ta.isEmpty() && (! tb.isEmpty()) && (! tc.isEmpty()) && (! td.isEmpty()) && ! te.isEmpty() ){
                    ...
                    Toast.makeText(c5.this, "Fields are missing!", Toast.LENGTH_LONG).show();
                }

                else if(! ta.isEmpty() && ! tb.isEmpty() && ! tb.isEmpty() && ! td.isEmpty() && ! te.isEmpty()){
                    if(! cc.equals(a) ){
                        ...
                        if((value<10 || value==10) && (vv<10 || vv==10) && (vc<10 || vc==10) && (vd<10 || vd==10) && (ve<10 || ve==10)){
                            final double sc = ((value*25)+(vv*24)+(vc*24)+(vd*24)+(ve*25))/122;
                        ...
                        else if((!(value<10 || value==10)) && (vc<10 || vc==10)&&(vv<10 || vv==10)&&(vd<10 || vd==10)&&(ve<10 || ve==10)){
                            a.setText("");
                        ...
                        else if ((value<10 || value==10) && (!(vv<10 || vv==10)) && (vc<10 || vc==10) && (vd<10 || vd==10)&&(ve<10 || ve==10)){
                            b.setText("");
                            ...
                            d.setText("");
                            h.setText("");
                            Toast.makeText(c5.this, "Enter a valid GPA", Toast.LENGTH_LONG).show();
                        }
                    }
                }
                else{
