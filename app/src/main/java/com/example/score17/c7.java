...
public class c7 extends AppCompatActivity {
    TextInputEditText a,b,c,d,h,i,j;
    RelativeLayout e;
    RelativeLayout f,g;
    TextView tt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(c7.this, "Created by Ashwin Balaji T R", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double value=0,vv=0,vc=0,vd=0,ve=0,vf=0,vg=0;
                String cc="90000000";

                if(ta.isEmpty() && tb.isEmpty() && tc.isEmpty() && td.isEmpty() && te.isEmpty() && tf.isEmpty() && tg.isEmpty()){
                    Toast.makeText(c7.this, "Enter all fields!", Toast.LENGTH_LONG).show();
                }

                else if(ta.isEmpty() && (! tb.isEmpty()) && (! tc.isEmpty()) && (! td.isEmpty()) && ! te.isEmpty() && !tf.isEmpty() && !tg.isEmpty()){
                    ...
                    Toast.makeText(c7.this, "Fields are missing!", Toast.LENGTH_LONG).show();
                }

                else if(! ta.isEmpty() && ! tb.isEmpty() && ! tb.isEmpty() && ! td.isEmpty() && ! te.isEmpty() && ! tf.isEmpty() && ! tg.isEmpty()){
                    if(! cc.equals(a) ){
                        ...
                        if((value<10 || value==10) && (vv<10 || vv==10) && (vc<10 || vc==10) && (vd<10 || vd==10) && (ve<10 || ve==10) && (vf<10 || vf==10) && (vg<10 || vg==10)){
                        ...
                        else if((!(value<10 || value==10)) && (vc<10 || vc==10)&&(vv<10 || vv==10)&&(vd<10 || vd==10)&&(vf<10 || vf==10)&&(ve<10 || ve==10)&&(vg<10 || vg==10)){
                            a.setText("");
                        ...
                        else if(((value<10 || value==10)) && (vc<10 || vc==10)&&(vv<10 || vv==10)&&(vd<10 || vd==10) & !(ve<10 || ve==10)&&(vf<10 || vf==10)&&(vg<10 || vg==10)){
                            h.setText("");
                        ...
                        else if ((value<10 || value==10) && (!(vv<10 || vv==10)) && (vc<10 || vc==10) && (vd<10 || vd==10)&&(ve<10 || ve==10) && (vf<10 || vf==10)&&(vg<10 || vg==10)){
                            b.setText("");
                            ...
                            i.setText("");
                            j.setText("");
                            Toast.makeText(c7.this, "Enter a valid GPA", Toast.LENGTH_LONG).show();
                        }
                    }
                }
                else{
